...
not_found_word_file = 'dataspace/baike.not_found_keyword_list.txt'
crawled_file = 'dataspace/baike.crawled_keyword.jsonl'
all_info_file = 'dataspace/baike.all_crawled_info.jsonl'
log_file = 'dataspace/baike.log.txt'
...
class Baike_spider():
    ...
    def crawl_from_file(self, keyword_file):
        ...
        total_data = crawl_main(keyword_list, self.Crawled_keyword_set, self.Crawled_url_set, self.Not_found_set)
    ...
    def crawl_from_list(self, keyword_list):
        ...
        new_not_found_keywords = len(self.Not_found_set) - origin_not_found_keywords_nums
        LOG_info(str(new_not_found_keywords) + " new keywords not found in Baidu Baike")
        return total_data, self.Not_found_set, self.Crawled_keyword_set
